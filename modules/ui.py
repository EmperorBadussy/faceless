    ...
    while not stop_event.is_set():
        ...
        if not modules.globals.map_faces:
            ...
            for frame_processor in frame_processors:
                if frame_processor.NAME in ("DLC.FACE-ENHANCER", "FACELESS.FACE-ENHANCER"):
                    ...
                    if modules.globals.fp_ui.get("face_enhancer_gpen512", False):
                        temp_frame = frame_processor.process_frame(None, temp_frame)
                elif frame_processor.NAME in ("DLC.FACE-SWAPPER", "FACELESS.FACE-SWAPPER"):
...
def create_webcam_preview(camera_index: int):
    ...
    def _display_next_frame():
        ...
        # FIX: Original had 5 redundant transforms here:
        ...
        # Removed redundant ImageOps.contain LANCZOS resize
